...
//print("The value of foo is \(foo)")
print("It won't be able to find foo in scope beacuse it is only useable inside the for loop.")
...
print("x is defined out side the if statement so it can be used. It is modified inside the for loop. foo is just defined in the for loop.")
...
greeting(greeting: nil, name: "Adison")
