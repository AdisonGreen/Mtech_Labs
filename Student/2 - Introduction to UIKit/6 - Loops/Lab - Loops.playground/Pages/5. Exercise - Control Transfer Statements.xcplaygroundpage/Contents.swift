...
for (index, everyOther) in alphabet.enumerated() {
...
var states: [String: String] = ["Colorado": "Denver", "Utah": "Salt Lake City", "Nevada": "Carson City"]
for (state, capitals) in states {
    print("\(capitals) is the capital of \(state)")
    
    if capitals == states["Utah"] {
