...
let somePlace = GPS(latitude: 51.414004, longitude: 0.125226)
print("Lat:", somePlace.latitude, "Long:",somePlace.longitude)
...
var favoriteBook = Book(title: "Mistborn", author: "Brandon Sanderson", pages: 541, price: 10.0)
