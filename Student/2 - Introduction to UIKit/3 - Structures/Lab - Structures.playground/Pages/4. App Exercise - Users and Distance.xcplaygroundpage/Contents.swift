...
var adison = User(name: "Adison", age: 17, height: 5.90, weight: 225, activityLevel: 3)
print(adison.name, adison.age, adison.height, adison.weight, adison.activityLevel)
/*:
