...
class ViewController: UIViewController {
    ...
    func createLayout() -> UICollectionViewLayout {
        let layout = UICollectionViewCompositionalLayout { sectionIndex, layoutEnvironment in
            ...
            let standardContentInsets = NSDirectionalEdgeInsets(top: 0, leading: 4, bottom: 0, trailing: 4)
            ...
            topLineItem.contentInsets = standardContentInsets
            ...
            bottomLineItem.contentInsets = standardContentInsets
            ...
            case .standard:
                ...
                let item = NSCollectionLayoutItem(layoutSize: itemSize)
                item.contentInsets = standardContentInsets
    ...
    func configureDataSource() {
        ...
        let essentailSectoion = Section.standard("Essential picks")
        snapshot.appendSections([popularSection, essentailSectoion])
        snapshot.appendItems(Item.popularApps, toSection: popularSection)
        snapshot.appendItems(Item.essentialApps, toSection: essentailSectoion)
