...
let tonsOfPeople = ["Bridger", "Brycen", "Avery", "Jonah"]

let sortedCollection1 = tonsOfPeople.sorted(by: forwards(name1:name2:))
...
let sortedCollection2 = tonsOfPeople.sorted { name1, name2 in
    return name1 < name2
}
...
let sortedCollection3 = tonsOfPeople.sorted { $0 < $1 }
